...
dv_libs_path  = project_dir + "/../mio_core_dv/dv/src"
...
def do_paths():
    ...
    set_env_var("DV_UVML_HRTBT_PATH"   , dv_libs_path + "/uvml_hrtbt"   )
    set_env_var("DV_UVML_TRN_PATH"     , dv_libs_path + "/uvml_trn"     )
    set_env_var("DV_UVML_LOGS_PATH"    , dv_libs_path + "/uvml_logs"    )
    set_env_var("DV_UVML_SB_PATH"      , dv_libs_path + "/uvml_sb"      )
    set_env_var("DV_UVML_RAL_PATH"     , dv_libs_path + "/uvml_ral"     )
    # Agents
